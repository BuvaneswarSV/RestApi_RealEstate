package com.example.springboot.register.controller;
...
import com.example.springboot.register.service.UserService;
...
public class UserController {
    ...
    @GetMapping("/register/getdetails")
    ...
    @PutMapping("/register/api/user/{userId}")
    ...
    @DeleteMapping("/register/api/user/{userId}")
