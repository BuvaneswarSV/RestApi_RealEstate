...
public class RegController {
    ...
    @GetMapping("/landdetails/api/product/sortBy/{field}")
    public List<Reg> g(@PathVariable String field)
    {
        return ms.sort(field);
    }
    @GetMapping("/landdetails/api/product/{offset}/{pagesize}/{field}")
    ...
    @GetMapping("/landdetails/api/product/{offset}/{pagesize}")
